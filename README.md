...
---
**Decreasing Bit Depth / Normalization**
...
The resulting image has pixels whose component values range from 0-3. Displaying pixels with these values will result in an extremely dark image. 
