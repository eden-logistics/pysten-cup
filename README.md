...
```python pystencup.py -e public.png private.png```

By default, the resulting output will be named `output.png`. To change this, use the -o flag.

```python pystencup.py -e public.png private.png -o hiddenimage.png```
...
```python pystencup.py -e public.png private.png -o hiddenimage.png -p hiddenpreview.png```
...
```python pystencup.py -d hiddenimage.png -o hiddendecode.png -n```